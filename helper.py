...
def run_every_minute(func, thread_name=None, *args, **kwargs):
    """
    In a new thread executes func() every minute.
    It starts with waiting for the nearest new minute to begin, then executes.
    If func() execution takes more than a minute it will repeat right after the previous execution completes.
    :param func: function to execute every minute
    :param thread_name: name of the thread to be created (useful for logging)
    :param args: arbitrary arguments passed to func()
    :param kwargs: arbitrary keyword arguments passed to func()
    :return: threading.Event, when you .set() it, execution stops
